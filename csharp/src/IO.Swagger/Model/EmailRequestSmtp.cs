...
namespace IO.Swagger.Model
{
        ...
        public partial class EmailRequestSmtp :  IEquatable<EmailRequestSmtp>, IValidatableObject
    {
        ...
        /// <param name="timeoutConnection">timeout creating smtp connection (default to 5.0).</param>
        ...
        public EmailRequestSmtp(string emailFrom = user@example.org, string helloName = "localhost", string proxy = default(string), decimal? timeoutConnection = 5.0, decimal? timeoutResponse = default(decimal?), int? port = 25)
        {
